...
1L)), class = "data.frame", row.names = c(NA, -9L)), vnam = "tGravityAcc_std()_X")
```
</div>
</div>
...
0L, 1L)), class = "data.frame", row.names = c(NA, -10L)), vnam = "tBodyAccJerk_mean()_X")
```
</div>
</div>
 ...
 *  Created by sanjiv (username: `ojhas`).

 *  Report creation time: Sun Feb 10 2019 21:17:11

 *  Report was run from directory: `C:/Users/ojhas/Documents/DataScTools/R/Week4Assignment/UCI HAR Dataset`
